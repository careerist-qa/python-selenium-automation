...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/jacobgrable/QA/python-selenium-automation/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/jacobgrable/QA/python-selenium-automation/venv/bin/deactivate.nu'
